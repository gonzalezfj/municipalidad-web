const BannerBoletas = ({ BoletasData }) => {
  return (
    <div className=''>
      ...
      <div className='bg-[#D85B35] w-full h-40 rounded-br-full'>
        <div className='container mx-auto flex items-center'>
          <svg className='w-36 h-40 relative -top-7 -left-6'>
            <image className='w-[200px] lg:w-[210px] xl:w-[210px] 2xl:w-[210px]' href={import.meta.env.VITE_STRAPI_URL + BoletasData?.Imagen.data.attributes.url} />
          </svg>
