...
const Eco =
    () => {
      return (
        <div className='top-0'>
          <div className='absolute px-5 flex top-0 w-screen h-52 bg-[#8A43EF] rounded-br-3xl'>
            <svg className='relative w-40 h-36 top-14'>
              <image href={logoEco} />
            </svg>
          ...
          <div>
            ...
            <div className='p-7 text-[#616161]'>
              ...
              <iframe className='w-full h-80 mt-2' src='https://www.google.com/maps/d/embed?mid=1vMRbLNy00DMVwnFeR64NihzBEQ-Ky1ep&ehbc=2E312F' />
            </div>
            <div className='bg-[#8A43EF] p-7 text-white'>
            ...
            <div className='p-7 text-[#616161]'>
              ...
              <button className='mt-2 p-2 font-bold bg-[#FFC14F] rounded-xl'>PLAYA DE REMOCIÓN</button>
            </div>
            <div className='p-7 text-[#616161]'>
