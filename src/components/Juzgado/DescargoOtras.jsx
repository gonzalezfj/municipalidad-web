...
import img1 from '@assets/gia_tramites_turnos_obleas/guíadeTramitesMobile_iconoJuzgado.svg'
      ...
      <div className='mx-auto gap-8 flex flex-col'>
        ...
        <div className='container mx-auto pt-40 lg:pt-64 gap-10 flex flex-col text-[#3E3E3E] font-semibold'>
          ...
          <div className='flex flex-col gap-4 px-8 lg:text-xl'>
            <h1 className='text-2xl flex flex-col font-extrabold text-[#4B0984] lg:text-3xl'>DESCARGO OTRAS INFRACCIONES <span className='text-base'>(DISTINTAS A INFRACCIONES DE TRÁNSITO)</span></h1>
            ...
            <section className='flex flex-col gap-3 lg:text-lg'>
              <a href='https://municipiosanjuan.gob.ar/descargoweb-juzgados' className='bg-[#4B0984] text-white flex justify-center items-center rounded-2xl w-44 h-12 lg:w-64 lg:text-xl font-extrabold'>TRAMITAR ONLINE</a>
              ...
              <a href='https://municipiosanjuan.gob.ar/descargoweb-transito' target='_blank' className='bg-[#FFC14F] rounded-2xl flex justify-center items-center w-56 h-16 lg:w-72 text-center lg:text-xl font-extrabold' rel='noreferrer'>INFRACCIONES DE TRANSITO</a>
            </section>
