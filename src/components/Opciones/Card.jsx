...
export const Card = () => {
  return (
    <div className='grid gap-x-14 gap-y-6 grid-cols-2 sm:gap-x-4 sm:gap-y-4 sm:grid-cols-3 mt-32 mb-20' >
      ...
      <div className='w-40 h-52 overflow-hidden shadow-lg bg-third rounded-primary flex flex-col items-center justify-center cursor-pointer' data-aos="fade-right">
        <div className='w-36 h-36'  >
          <img src={boletas} className='object-cover' alt='Boletas' />
        </div>
        <div className='flex-1 w-40 flex items-center justify-center transition ease-in-out delay-150 bg-secondary hover:bg-purple-600 duration-200'>
      ...
      <div className='w-40 h-52 overflow-hidden shadow-lg bg-third rounded-primary flex flex-col items-center justify-center cursor-pointer' data-aos="fade-right">
        ...
        <div className='flex-1 w-40 flex items-center justify-center transition ease-in-out delay-150 bg-secondary hover:bg-purple-600 duration-200'>
          <h4 className='text-xs ml-6 w-full h-full items-center flex text-slate-50'>ESTACIONAMIENTO CONTROLADO</h4>
        </div>
      </div>

      <div className='w-40 h-52 overflow-hidden shadow-lg bg-third rounded-primary flex flex-col justify-center items-center cursor-pointer' data-aos="fade-right">
        <div className='w-36 h-36' >
      ...
      <div className='w-40 h-52 overflow-hidden shadow-lg bg-third rounded-primary flex flex-col items-center justify-center cursor-pointer' data-aos="fade-right">
        ...
        <div className='flex-1 w-40 flex items-center justify-center transition ease-in-out delay-150 bg-secondary hover:bg-purple-600 duration-200'>
          <h4 className='text-sm ml-10 text-slate-50'>GESTION DE TRAMITES</h4>
        </div>
      </div>
