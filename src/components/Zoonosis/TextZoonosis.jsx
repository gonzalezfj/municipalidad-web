...
const TextZoonosis = () => {
  return (
    <div className='flex flex-col justify-center mt-4 items-center gap-4 p-7 text-[#616161]'>
      <h1 className='text-[#4B0984] te font-extrabold'>ESTERILIZACIÓN DE MASCOTAS</h1>
