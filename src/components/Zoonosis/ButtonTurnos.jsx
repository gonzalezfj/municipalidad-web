  ...
  return (
    <div className='flex flex-col gap-4 p-7 text-[#616161]'>
      ...
      <div className='flex gap-4'>
        <button className='bg-[#FFC14F] w-36 h-36 lg:w-48 lg:h-48 rounded-3xl lg:flex lg:justify-center lg:items-center'>
      ...
      <div className='flex justify-center items-center lg:justify-normal'>
        <button className='bg-[#9747FF] rounded-full text-white font-bold p-2 w-32'>Mis turnos</button>
      </div>
    </div>
  )
}
