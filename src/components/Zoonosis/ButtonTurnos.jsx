  ...
  return (
    <div className='flex flex-col gap-4 p-7 text-[#616161]'>
      ...
      <div className='flex gap-4'>
        <a href='https://municipiosanjuan.gob.ar/zoonosis/esterilizacion-de-perros' target='_blank' className='bg-[#FFC14F] w-36 h-36 lg:w-48 lg:h-48 rounded-3xl lg:flex lg:justify-center lg:items-center' rel='noreferrer'>
          <svg className='w-36 h-36'>
            <image className='w-36 h-36' href={imgPerro} />
          </svg>
        </a>
        <a href='https://municipiosanjuan.gob.ar/zoonosis/esterilizacion-de-gatos' target='_blank' className='bg-[#FFC14F] w-36 h-36 lg:w-48 lg:h-48 rounded-3xl lg:flex lg:justify-center lg:items-center' rel='noreferrer'>
