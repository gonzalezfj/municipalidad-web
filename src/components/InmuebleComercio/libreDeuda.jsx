        ...
        <div className='w-full'>
            <div className='mx-auto gap-8 flex flex-col'>
                ...
                <div className='px-8 gap-4 flex flex-col lg:items-center lg:justify-center'>
                    ...
                    <div className='cursor-pointer lg:w-2/4 lg:h-96'>
                        <img src={img1} alt="" className='lg:w-full lg:h-full lg:object-cover' />
                    </div>
                </div>
                {/* TEXT Y BUTTON */}
                ...
                <div className='px-10 py-4'>
                    <div className='flex flex-col-2 lg:items-center lg:justify-center lg:flex lg:gap-10'>
                        ...
                        <div className='flex items-center z-10'>
                            <button className='font-extrabold text-sm text-white bg-purple-800 px-6 h-11 rounded-3xl lg:rounded-primary lg:text-2xl lg:px-4 lg:h-20'>Autenticidad libre deuda</button>
                        </div>
                    </div>
                    {/* IMG */}
